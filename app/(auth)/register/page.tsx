...
import {ArrowLeft, HeartPulse, Loader2, ShieldCheck} from "lucide-react";
    ...
    return (
        <div
                ...
                <div className="relative z-10 mt-auto space-y-10">
                    ...
                    <div className="space-y-4 max-w-md">
                        ...
                        <p className="text-lg text-muted-foreground font-light leading-relaxed">
                            Create a global account to track workouts, access your membership cards, and securely
                            connect to partner facilities.
                        </p>
                    </div>
            ...
            <div className="relative flex items-center justify-center p-8 lg:p-12 bg-background">
                {/* 🚀 Suspense wrapper required for reading client search params cleanly */}
                <Suspense fallback={
                    <div className="flex flex-col items-center justify-center space-y-4 text-muted-foreground">
                        <Loader2 className="w-6 h-6 animate-spin text-primary"/>
                        <span className="text-xs font-bold uppercase tracking-widest">Initializing Handshake...</span>
                    </div>
                }>
                    <RegisterForm/>
                </Suspense>
