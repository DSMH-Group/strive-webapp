...
export default function HomePage() {
    return (
        <div className="flex flex-col items-center w-full">
            ...
            <section
                className="relative w-full px-6 py-24 md:py-40 flex flex-col items-center text-center overflow-hidden">
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-primary/5 rounded-full blur-[120px] -z-10 pointer-events-none"/>
                <Badge variant="outline"
                       className="mb-8 border-primary/20 bg-primary/10 text-primary px-4 py-1.5 text-xs font-bold tracking-widest uppercase">
            ...
            <section className="w-full border-y border-border bg-card/30">
                <div
                    className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-border">
            ...
            <section className="w-full max-w-7xl px-6 py-32">
                <div className="flex flex-col lg:flex-row items-center gap-20">
                    <div className="flex-1 space-y-8">
                        <Badge className="bg-primary/10 text-primary border-none">THE BRANDED EXPERIENCE</Badge>
                    ...
                    {/* PHONE MOCKUP */}
                    <div
                        className="flex-1 w-full max-w-md bg-card rounded-[40px] p-3 border border-border shadow-2xl relative overflow-hidden aspect-[9/19]">
                        <div
                            className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-7 bg-background rounded-b-3xl z-10 border-b border-border border-x"/>
                        <div
                            className="w-full h-full bg-background rounded-[30px] p-6 flex flex-col pt-14 border border-border/50 relative">
                            <div className="flex items-center gap-3 mb-10">
                                <div
                                    className="w-10 h-10 bg-primary/20 border border-primary rounded-xl flex items-center justify-center">
                            ...
                            <div className="bg-card border border-primary/30 rounded-2xl p-5 mb-6 relative">
                                <div className="absolute left-0 top-0 w-1 h-full bg-primary"/>
                                <div className="text-[10px] text-primary font-bold mb-2 uppercase">Active Membership
                                </div>
            ...
            <section id="audience" className="w-full py-32 bg-secondary/10 border-y border-border">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <AudienceCard title="Independent Gym" pain="Drowning in manual admin & cash tracking."
                                      angle="Lead with: Time saved & payment transparency."/>
                        <AudienceCard title="Personal Trainer" pain="Client management is scattered on WhatsApp."
                                      angle="Lead with: Professional image & client experience."/>
                        <AudienceCard title="Multi-Branch" pain="No visibility across locations or reporting."
                                      angle="Lead with: Scalability & unified dashboard."/>
                        <AudienceCard title="Specialized Studio" pain="Generic tools don't fit Yoga, MMA, or Clubs."
                                      angle="Lead with: Flexibility & domain-specific modules."/>
                    </div>
                </div>
            </section>
            ...
            <section id="roi" className="w-full max-w-7xl px-6 py-32">
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-8">
                        <Badge className="bg-primary/10 text-primary">ROI ANALYSIS</Badge>
                        <h2 className="text-4xl md:text-5xl font-bold">Stop losing money on <span
                            className="text-primary italic">doing nothing.</span></h2>
                        <div className="space-y-6">
                            <RoiPoint title="The One-Payment Rule"
                                      desc="Recovering one missed payment per month typically covers your entire Strive subscription."/>
                            <RoiPoint title="Reclaim your Saturdays"
                                      desc="Automate the 10+ hours of manual payment chasing and spreadsheet updating you do every week."/>
                        </div>
                    </div>
                    <Card className="bg-card border-primary/20 p-10 rounded-[2.5rem] shadow-2xl relative">
                        ...
                        <CardContent className="px-0 space-y-6">
                            <div className="flex justify-between items-center py-4 border-b border-border">
                                ...
                                <span className="text-xl font-bold text-red-500">10-15%</span>
                            </div>
            ...
            <section className="w-full max-w-4xl px-6 py-32">
                ...
                <Accordion className="w-full">
                    <AccordionItem value="item-1" className="border-border px-4 py-2">
                        <AccordionTrigger
                            className="text-lg font-bold hover:text-primary transition-colors italic tracking-tight">&#34;We
                            already use WhatsApp to manage members.&#34;</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2" className="border-border px-4 py-2">
                        <AccordionTrigger
                            className="text-lg font-bold hover:text-primary transition-colors italic tracking-tight">&#34;Our
                            members aren&#39;t very tech-savvy.&#34;</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground font-light text-base leading-relaxed">
                    ...
                    <AccordionItem value="item-3" className="border-border px-4 py-2">
                        <AccordionTrigger
                            className="text-lg font-bold hover:text-primary transition-colors italic tracking-tight">&#34;We&#39;ve
                            tried software before and it failed.&#34;</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground font-light text-base leading-relaxed">
            ...
            <section className="w-full py-32 bg-primary flex flex-col items-center text-center px-6">
                <h2 className="text-4xl md:text-6xl font-black text-primary-foreground mb-10 tracking-tighter">Ready to
                    reclaim your time?</h2>
                <Button size="lg" variant="secondary"
                        className="h-16 px-12 rounded-2xl text-xl font-bold shadow-2xl hover:scale-105 transition-transform">
...
function StatBlock({value, label}: { value: string, label: string }) {
    return (
        <div className="pt-8 md:pt-0">
            ...
            <div
                className="text-muted-foreground font-medium max-w-[200px] mx-auto text-sm leading-relaxed">{label}</div>
        </div>
    );
}
...
function AudienceCard({title, pain, angle}: { title: string, pain: string, angle: string }) {
    return (
        <Card className="bg-card border-border h-full flex flex-col hover:border-primary/50 transition-colors">
            <CardHeader>
                <CardTitle className="text-xl text-primary tracking-tight">{title}</CardTitle>
            </CardHeader>
            <CardContent className="flex-1 flex flex-col gap-4">
                <p className="text-xs text-muted-foreground leading-relaxed"><span
                    className="text-red-500 font-black uppercase mr-1">Pain:</span>{pain}</p>
                <p className="text-xs text-foreground font-bold mt-auto"><span
                    className="text-primary uppercase mr-1">Angle:</span>{angle}</p>
            </CardContent>
        </Card>
    );
}
